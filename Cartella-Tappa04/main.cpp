    ...
    for (unsigned int r = 0; r < rings - 1; ++r) 
    {
        for (unsigned int s = 0; s < sectors - 1; ++s) 
        {
            indices.insert(indices.end(), {r * sectors + s, r * sectors + (s + 1), (r + 1) * sectors + (s + 1),
                                           r * sectors + s, (r + 1) * sectors + (s + 1), (r + 1) * sectors + s});
        }
    }
}
...
int main() 
{
    ...
    window.create(sf::VideoMode({1280, 720}), "Star Wars Planetary System - Tappa 04", sf::State::Windowed, settings);
    ...
    std::cout << "========================================================\n";
    std::cout << "  Star Wars Planetary System - Tappa 04 \n";
    std::cout << "========================================================\n";
    ...
    {
        {"Mustafar", -6.5f, 4.0f, 0.70f, glm::vec3(0.82f, 0.15f, 0.15f), 0.0f}, 
        {"Tatooine", -3.2f, 2.5f, 0.60f, glm::vec3(0.92f, 0.82f, 0.58f), 0.7f}, 
        {"Hoth",      3.2f, 3.0f, 0.55f, glm::vec3(0.70f, 0.86f, 0.94f), 1.4f}, 
        {"Endor",     6.5f, 1.8f, 0.75f, glm::vec3(0.13f, 0.54f, 0.13f), 2.1f}  
    };
    ...
    while (window.isOpen()) {
        ...
        glm::mat4 view = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, cameraZoom)); 
