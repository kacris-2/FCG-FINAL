...
int main() 
{
    ...
    window.create(sf::VideoMode({1280, 720}), "Star Wars Planetary System - Tappa 08", sf::State::Windowed, settings);
    ...
    std::cout << "========================================================\n";
    std::cout << "  Star Wars Planetary System - Tappa 08  \n";
    std::cout << "========================================================\n";
    ...
    while (window.isOpen()) {
        while (const std::optional<sf::Event> event = window.pollEvent()) 
        {
            ...
            if (const auto* keyPressed = event->getIf<sf::Event::KeyPressed>()) {
                ...
                // dinamic change of target
                if (keyPressed->code == sf::Keyboard::Key::Num0) currentTarget = -1; // Sol
